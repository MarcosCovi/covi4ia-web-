...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-brand-navy hero-grid"
    >
      {/* Background blobs */}
      <div
        className="absolute -top-40 -right-40 w-[700px] h-[700px] rounded-full animate-pulse-slow pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(0,212,255,0.15) 0%, transparent 65%)' }}
      />
      <div
        className="absolute -bottom-20 -left-20 w-[400px] h-[400px] rounded-full animate-pulse-slow pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(196,123,56,0.10) 0%, transparent 70%)', animationDelay: '2s' }}
      />
      <div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[300px] pointer-events-none"
        ...
        <div className="flex flex-col items-start max-w-3xl">
          ...
          <div className="mb-2 -ml-4">
            <Image
              ...
              width={220}
              height={220}
              className="drop-shadow-[0_0_40px_rgba(0,212,255,0.35)]"
              priority
            />
          </div>

          {/* Brand name — "4" en cyan */}
          <h1 className="font-display font-bold tracking-tight leading-none mb-3"
          ...
          <div className="mb-3">
            <p className="text-brand-mid-gray text-xs sm:text-sm font-semibold tracking-[0.25em] uppercase mb-2">
              Engineering the{' '}
              <span className="text-brand-cyan">Web4</span>{' '}
              Enterprise
            </p>
          ...
          {/* Description */}
          <p className="text-brand-mid-gray text-base sm:text-lg max-w-xl leading-relaxed mt-4 mb-8">
          ...
          <div className="mt-14 flex flex-wrap gap-6 sm:gap-10">
            {[
              ...
              <div key={s.verb} className="flex flex-col gap-0.5">
                <span className="font-display text-sm font-bold text-brand-cyan tracking-widest">
                  {s.verb}
                </span>
